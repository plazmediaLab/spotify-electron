...
export default function AlbumListItem({ item, index }) {
  ...
  return (
    <tr
      ...
      className="truncate select-none group normal-case text-sm tracking-wider hover:bg-background-middlelight border-b border-background-middlelight">
      ...
      <td className={`px-3 text-secondary ${onPlay ? 'text-brand-400' : ''}`}>
        <p
          className="truncate"
          style={{
            maxWidth: '90%'
